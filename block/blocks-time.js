...
Blockly.Blocks['mcp7941_rtc_set_datetime_form_ntp'] = {
	init: function () {
		this.appendDummyInput()
		.appendField("RTC : sync internet WiFi ssid")
        .appendField(new Blockly.FieldTextInput("test"), "ssid")
        .appendField("password")
        .appendField(new Blockly.FieldTextInput("test"), "password")
		.appendField("time out")
        .appendField(new Blockly.FieldNumber("10"), "timeout")
		.appendField("s");
		this.setInputsInline(true);
		this.setOutput(true, "Boolean");
		this.setColour(rtc_colour);
		this.setTooltip("Set Date/Time form internet (Boolean)");
		this.setHelpUrl("");
	}
};
Blockly.Blocks['mcp7941_rtc_get_DateTime'] = {
	init: function () {
		this.appendDummyInput()
			.appendField("RTC : DateTime");
		this.setInputsInline(true);
		this.setOutput(true, "String");
		this.setColour(rtc_colour);
		this.setTooltip("Get Date/Time (String)");
		this.setHelpUrl("");
	}
};
Blockly.Blocks['mcp7941_rtc_get_Date'] = {
	init: function () {
		this.appendDummyInput()
			.appendField("RTC : Date");
		this.setInputsInline(true);
		this.setOutput(true, "String");
		this.setColour(rtc_colour);
		this.setTooltip("Get Date (String)");
		this.setHelpUrl("");
	}
};
Blockly.Blocks['mcp7941_rtc_get_Time'] = {
	init: function () {
		this.appendDummyInput()
			.appendField("RTC : Time");
		this.setInputsInline(true);
		this.setOutput(true, "String");
		this.setColour(rtc_colour);
		this.setTooltip("Get Time (String)");
		this.setHelpUrl("");
	}
};
