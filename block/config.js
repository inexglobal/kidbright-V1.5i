...
module.exports = {
  blocks: [ // use "blocks : [ " in normally situation but this need to override base block from esp-idf platforms
    ...
    },
    {
      name: "Actuator",
      color: "330",
      icon: `file:///${dirIcon}/static/actuator.svg`,
      blocks: [
	    "esp32_servo_attach",
        "esp32_servo_write",
    ...
    },
    {
      name: "Storage",
      color: "330",
      icon: `file:///${dirIcon}/static/memo.png`,
      blocks: [
	    {
                    xml : 
    ...
    },
    {
      ...
      blocks: [
		...
		"mcp7941_rtc_set_datetime_form_ntp",
        "mcp7941_rtc_get_DateTime",
        "mcp7941_rtc_get_Date",
        "mcp7941_rtc_get_Time",
